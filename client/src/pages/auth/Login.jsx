            ...
            >
                ...
                >
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="btn-primary w-full h-12 flex items-center justify-center gap-2 font-black uppercase tracking-widest text-xs"
                    >
                        {loading ? 'Authenticating...' : (
                            <>
                                Grant Access <ArrowRight className="w-4 h-4" />
                            </>
                        )}
                    </button>
                </motion.form>
