...
import {
    ...
    CheckCircle2, Clock, Share2, MessageSquare, Plus, Video, Code, Award
} from 'lucide-react';
                    ...
                    <div className="glass-card p-8">
                        <div className="flex gap-8 border-b border-white/5 mb-8 overflow-x-auto">
                            {['Overview', 'Lecture Notes', 'Assignments', 'Student Doubts'].map((tab, i) => (
                                <button key={i} className={`pb-4 text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap ${i === 0 ? 'text-primary-400 border-b-2 border-primary-500' : 'text-gray-500 hover:text-white'}`}>
                                    {tab}
                                </button>
                            ))}
                        </div>
