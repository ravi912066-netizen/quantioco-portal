                        ...
                        <div className="flex-1 flex flex-col">
                            {activeRoom.meetLink ? (
                                <div className="flex-1 flex flex-col items-center justify-center p-8 bg-dark-900 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/20 via-dark-900 to-dark-900 m-4 rounded-2xl border border-blue-500/10 shadow-glow shadow-blue-500/5">
                                    ...
                                    <p className="text-gray-400 text-sm mb-8 text-center max-w-md font-medium leading-relaxed">This session is being hosted securely via Google Meet. Click below to enter the command center in a new terminal.</p>
                                    <a
                                    ...
                                    >
                                        <Video className="w-5 h-5" /> Launch Meet
                                    </a>
                                </div>
                            ) : (
                                <JitsiMeeting
